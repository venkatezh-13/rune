...
pub enum Op {
    ...
    F32Sqrt, F32Min, F32Max, F32Abs, F32Neg, F32Ceil, F32Floor,

    // ── f64 arithmetic ───────────────────────────────────────────────────────
    F64Add, F64Sub, F64Mul, F64Div,
    F64Sqrt, F64Min, F64Max, F64Abs, F64Neg, F64Ceil, F64Floor,
...
impl Function {
    ...
    pub fn new(
        ...
        Function { name: name.into(), ty, locals, body: Arc::new(body) }
    }
}
